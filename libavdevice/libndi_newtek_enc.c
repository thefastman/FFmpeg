...
<<<<<<< HEAD
    if (ctx->ndi_send)
    {
        p_NDILib->send_destroy(ctx->ndi_send);
=======
    if (ctx->ndi_send) {
...
<<<<<<< HEAD
    ...
    p_NDILib->send_send_video_async_v2(ctx->ndi_send, ctx->video);
=======
    av_log(avctx, AV_LOG_DEBUG, "%s: pkt->pts=%"PRId64", timecode=%"PRId64", st->time_base=%d/%d\n",
        __func__, pkt->pts, ctx->video->timecode, st->time_base.num, st->time_base.den);
...
<<<<<<< HEAD
    ...
    p_NDILib->util_send_send_audio_interleaved_16s(ctx->ndi_send, ctx->audio);
=======
    av_log(avctx, AV_LOG_DEBUG, "%s: pkt->pts=%"PRId64", timecode=%"PRId64", st->time_base=%d/%d\n",
        __func__, pkt->pts, ctx->audio->timecode, st->time_base.num, st->time_base.den);
...
<<<<<<< HEAD
    ctx->ndi_send = p_NDILib->send_create(&ndi_send_desc);
    if (!ctx->ndi_send)
    {
=======
